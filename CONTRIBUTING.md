...
These contributing guidelines are adapted from the Auth0 [general contributing guidelines template][auth0-code-of-conduct].

[auth0-code-of-conduct]: https://github.com/auth0/open-source-template/blob/master/GENERAL-CONTRIBUTING.md